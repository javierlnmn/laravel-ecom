    <div id="message-pop-up-container" class="fixed top-5 left-0 right-0 animate-enter-screen w-[500px] max-w-[90%] mx-auto bg-red-500 text-zinc-100 flex flex-col {{$additionalClassesBox ?? ''}}">
